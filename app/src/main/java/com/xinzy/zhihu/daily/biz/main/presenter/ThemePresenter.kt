...
import com.xinzy.zhihu.daily.biz.main.model.Editors
import com.xinzy.zhihu.daily.biz.main.model.ThemeDaily
import com.xinzy.zhihu.daily.biz.main.model.ThemeTop
import com.xinzy.zhihu.daily.util.themeDaily

/**
 * Created by Xinzy on 2018/3/28.
 */
class ThemePresenter(private val mView: ThemeConstract.View, id: Int) : ThemeConstract.Presenter {
